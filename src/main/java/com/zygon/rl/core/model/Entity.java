...
public class Entity {
    ...
    // Return the available behaviors 'otherEntity' has to interact with 'this' entity
    @Deprecated // this needs to be handled elsewhere
    public Set<Behavior> getAvailableBehaviors(Entity otherEntity) {
